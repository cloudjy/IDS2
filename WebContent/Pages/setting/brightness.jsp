...
if (currentSetting != null && currentSetting.mLocal != null) {
	CurrentBrightness = LocalConfig.timeBoundIntToText(currentSetting.mLocal.mBrightness);
} 
...
if (assignSetting != null && assignSetting.mLocal != null) {
	AssignBrightness = LocalConfig.timeBoundIntToText(assignSetting.mLocal.mBrightness);
	RemoteModify = (assignSetting.mLocal.mBrightness != null);
} 
%>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0" class="bdTab"> 
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="brightness_time_range"/>1:   
								</td>
								...
								<td style="width: 30%">
									<s:text name="prompt_brightness" /><select size="1" id="brightness1">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="brightness_time_range"/>2:   
								</td>
								<td style="width: 20%" align="right">
								...
								<td style="width: 30%">
									<s:text name="prompt_brightness" /><select size="1" id="brightness2">
					                  <option value="0">0</option>
					                  <option value="1">1</option> 
					                  <option value="2">2</option> 
					                  <option value="3">3</option> 
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="brightness_time_range"/>3:   
								</td>
								<td style="width: 20%" align="right">
								...
								<td style="width: 30%">
									<s:text name="prompt_brightness" /><select size="1" id="brightness3">
					                  <option value="0">0</option>
					                  <option value="1">1</option> 
					                  <option value="2">2</option> 
					                  <option value="3">3</option> 
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="brightness_time_range"/>4:   
								</td>
								<td style="width: 20%" align="right">
								...
								<td style="width: 30%">
									<s:text name="prompt_brightness" /><select size="1" id="brightness4">
					                  <option value="0">0</option>
					                  <option value="1">1</option> 
					                  <option value="2">2</option> 
					                  <option value="3">3</option> 
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="brightness_time_range"/>5:   
								</td>
								<td style="width: 20%" align="right">
								...
								<td style="width: 30%">
									<s:text name="prompt_brightness" /><select size="1" id="brightness5">
					                  <option value="0">0</option>
					                  <option value="1">1</option> 
					                  <option value="2">2</option> 
					                  <option value="3">3</option> 
					...
					<td style="width:40%">
						<table width="100%" border="0" cellspacing="2" cellpadding="0" class="bdTab"> 
							<tr> 
								...
								<td style="width: 40%"> 
									<s:text name="prompt_brightness" /> 
									<span id="c_brightness1"></span>
								</td> 
							</tr> 
							<tr> 
								<td style="width: 30%" align="right"> 
...
$(function () { 
	$("#li_brightness").addClass("curItem"); 
...
function configItemEnable(enable) {	 
	var configItemArray = [
		$("#start_time1"), $("#end_time1"), $("#brightness1"), 
    	$("#start_time2"), $("#end_time2"), $("#brightness2"), 
    	$("#start_time3"), $("#end_time3"), $("#brightness3"), 
    	$("#start_time4"), $("#end_time4"), $("#brightness4"), 
    	$("#start_time5"), $("#end_time5"), $("#brightness5") 
    ]; 
...
function submitConfig() { 
	...
	$.post('/Pages/setting!putBrightness', params,  function(result) {
...
function fillData() { 
	var timeBounds = null;
	var assignText= "<%=AssignBrightness != null && AssignBrightness.length()>0? AssignBrightness : "[00:00,23:59,10]"%>";
	var currentText= "<%=CurrentBrightness%>";
	...
	var inputArray = [
		{start : $("#start_time1"), end : $("#end_time1"), value : $("#brightness1")}, 
		{start : $("#start_time2"), end : $("#end_time2"), value : $("#brightness2")}, 
		{start : $("#start_time3"), end : $("#end_time3"), value : $("#brightness3")}, 
		{start : $("#start_time4"), end : $("#end_time4"), value : $("#brightness4")}, 
		{start : $("#start_time5"), end : $("#end_time5"), value : $("#brightness5")}
	]; 
	...
	var spanArray = [
   		{start : $("#c_start_time1"), end : $("#c_end_time1"), value : $("#c_brightness1")}, 
   		{start : $("#c_start_time2"), end : $("#c_end_time2"), value : $("#c_brightness2")}, 
   		{start : $("#c_start_time3"), end : $("#c_end_time3"), value : $("#c_brightness3")}, 
   		{start : $("#c_start_time4"), end : $("#c_end_time4"), value : $("#c_brightness4")}, 
   		{start : $("#c_start_time5"), end : $("#c_end_time5"), value : $("#c_brightness5")}
	]; 
...
function resetConfig() { 
	if ($("#radio_remote:radio").is(":checked")) { 
		...
		var defaultText = "[00:00,23:59,10]";
