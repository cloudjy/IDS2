...
if (currentSetting != null && currentSetting.mLocal != null) {
	CurrentDownload = LocalConfig.timeBoundToText(currentSetting.mLocal.mDownload);
} 
...
if (assignSetting != null && assignSetting.mLocal != null) {
	AssignDownload = LocalConfig.timeBoundToText(assignSetting.mLocal.mDownload);
	RemoteModify = (assignSetting.mLocal.mDownload != null);
} 
%>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0" class="bdTab">
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="download_time_range"/>1:   
								</td>
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="download_time_range"/>2:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="download_time_range"/>3:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="download_time_range"/>4:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="download_time_range"/>5:   
								</td>
								<td style="width: 35%" align="right">
...
function submitConfig() { 
	...
	$.post('/Pages/setting!putDownload', params,  function(result) {
...
function fillData() { 
	var timeBounds = null;
	var assignText= "<%=AssignDownload != null && AssignDownload.length()>0? AssignDownload : "[00:00,23:59]"%>";
	var currentText= "<%=CurrentDownload%>";
...
function resetConfig() {   
	if ($("#radio_remote:radio").is(":checked")) {  
		$("#start_time1").val(formatHHmm(0));
		$("#end_time1").val(formatHHmm(23*3600 + 59*60));
