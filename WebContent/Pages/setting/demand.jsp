...
if (currentSetting != null && currentSetting.mLocal != null) {
	CurrentDemand = LocalConfig.timeBoundToText(currentSetting.mLocal.mDemand);
} 
...
if (assignSetting != null && assignSetting.mLocal != null) {
	AssignDemand = LocalConfig.timeBoundToText(assignSetting.mLocal.mDemand);
	RemoteModify = (assignSetting.mLocal.mDemand != null);
} 
%>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0" class="bdTab">
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="demand_time_range"/>1:   
								</td>
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="demand_time_range"/>2:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="demand_time_range"/>3:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="demand_time_range"/>4:   
								</td>
								<td style="width: 35%" align="right">
							...
							<tr> 
								<td style="width: 30%" align="center">
									<s:text name="demand_time_range"/>5:   
								</td>
								<td style="width: 35%" align="right">
...
function submitConfig() { 
	...
	$.post('/Pages/setting!putDemand', params,  function(result) {
...
function fillData() { 
	var timeBounds = null;
	var assignText= "<%=AssignDemand != null && AssignDemand.length()>0? AssignDemand : "[00:00,23:59]"%>";
	var currentText= "<%=CurrentDemand%>";
