<%@page import="com.gnamp.server.model.MarqueeXML"%>
...
MarqueeXML vo = (MarqueeXML)request.getAttribute("marquee");
%>
...
function doSubmit() {   	
	...
	ajaxCallback("tag!editTextTag",param,function(msg) {    				
			if(msg.success){
		...
		<tr>
			...
			<%-- <input type="text" style="width: 250px;"
				...
				<textarea name="text" id="text"
                              cols="50" rows="3"><%=vo.getText()%></textarea>
				</td>
		</tr>
		<tr>
					<td class="bt">&nbsp;</td>
