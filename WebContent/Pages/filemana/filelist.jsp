...
<body>
	...
	<div class="mid1">
		<div class="bt1">
				<ul class="tab1">
					<li onclick="location.href='file.action'" class="hover"><s:text name="file"/></li>
			...
			<form class="topSearchMk2 topSearchMk3" style="margin-top: -10px;">
                ...
                <tr>
				 	<td style="width: 29px;" class="lbButton" title="<s:text name="thumbview"/>">
                        <img src="${theme}/skins/default/images/selectPic.gif" width="21" height="21" id="view" class="hover"/>
                        
                    </td>
                    <td style="width:29px;"  class="lbButton"  title="<s:text name="listview"/>">
                    	<img src="${theme}/skins/default/images/selectLb.gif" width="21" height="21"  id="list"/>
                    </td>
                    ...
                    <td style="width: 5px;" ></td>
                    <td style="width: 50px;text-align:right;"><s:text name="auditstate"/></td>
                    <td style="width: 77px;">
                    ...
                    <td style="width: 5px;" ></td>
                    <td style="width:143px; overflow:hidden;" class="search" >
					    <div class="searchL">
		...
		<div class="nr1">
			...
			<div class="left1">
				...
				<div class="leftMenu" >
					<div class="leftMenuBta hover">
					 <div style="cursor: pointer;" onclick="loadRoot()"><s:text name="rootgroup" /></div>
					</div>
						   <div class="leftMenuGd dumascroll" id="groupListDiw" style="height:75%;">
				...
				<s:if test="#session.current_privilege.newcatalog">
					<a href="javascript:addNode()"><s:text name="create" /></a>
				</s:if>
				<s:if test="#session.current_privilege.editdir">
					<a href="javascript:editNode()"><s:text name="edit" /></a>
				</s:if>
				<s:if test="#session.current_privilege.deldir">
					<a href="javascript:removeNode()"  
						title="<s:text name="title_delete_directroy_button"/>">
						<s:text name="delete" /></a>
				</s:if>
				<a id="category_sort" name="category_sort" href="javascript:categorysort();">A-Z</a>
				</div>
			...
			<div class="right1">
				...
				<div class="rightMenu" style="height: 20px;" id="ee_bottom_button" name="ee_bottom_button">
					<ul class="left rightMenuLong">
						<s:if test="#session.current_privilege.uploadfile">
							<li id="fileupload" ><font color="#FF0000" size="3">&#x25B4;</font><s:text name="upload"/></li>
						</s:if>
						<li id="download"><s:text name="download"/></li>
						<s:if test="#session.current_privilege.editfile">
							<li id="edit" ><s:text name="edit"/></li>
						</s:if>
							<li id="check" title="<s:text name="title_chekc_button" />"><s:text name="check"/></li>
						<s:if test="#session.current_privilege.delfiles">
							<li id="del"><s:text name="text_delete"/></li>
						</s:if>
						<s:if test="#session.current_privilege.auditfile">
							<li id="audit"><s:text name="audit"/></li>
						</s:if>
						<%--
						<s:if test="#session.current_privilege.uploadfile">
							<li id="jfileupload"><s:text name="upload"/>(J)</li>
						</s:if>
						 --%>
						<!-- li id="mms"><s:text name="MMS"/></li -->
					</ul>
				</div>
				<div style="font-size:12px;padding-left:20px;"><s:text name="bottom_prompt_file_manager"/></div>
				...
				<div class="bottomMenu">
					<div class="rightSelect" style="width:250px;">
							...
							<s:if test="#session.current_privilege.auditfile">
								<span>
									<input id="autocheck" name="chdk" type="checkbox" 
										checked="checked"/>
									<s:text name="autoaudit"/>
								</span>
							</s:if>
							<s:else>
