  ...
  %>
	...
	<div class="tcWindow">
		...
		<form id="form1" class="niceform">	
		  <input type="hidden" value="<%=task.getTaskId() %>" name="looptask.taskId" />	
				...
				<tr>
					...
					<td align="left">
					 <% if (onlyTaskSize == null ) {%> 
						<input type="text" value="${looptask.taskName }"  id="looptask.taskName" name="looptask.taskName" />
				...
				<tr>
					...
					<td align="left">
					<% if (onlyTaskSize == null ) {%> 
						<input type="text" value="${looptask.description}"  id="looptask.description" name="looptask.description" />
					<% } else { %>
						${looptask.description }
					 <% } %>
					</td>
				</tr>
				<tr>
