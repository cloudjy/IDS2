...
<script type="text/javascript"> 
	...
	function addTTSText(callfunc){  
		...
		var surl = "<%= _actionName %>!ttsTextAdd";  
		var param = { 
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="0"
							...
							<tr>
								<td style="padding-left: 0px;padding-right: 3px;">
								 	<input type="radio" name="play_mode" id="repeat_mode" value="repeat"
								 		checked  style="margin: 0;" onchange="onPlayRepeatRadioChange();" /> 
								</td>
								<td style="padding-left: 0px;">
							...
							<tr>
								<td style="padding-left: 0px;padding-right: 3px;">
								 	<input type="radio" name="play_mode" id="count_mode" value="count" 
								 		style="margin: 0;" onchange="onPlayCountRadioChange();"/>
								</td>
								<td style="padding-left: 0px;">
				...
				<tr>
					...
					<td><input type="button" value="<s:text name="yes"/>"
						onclick="addTTSText(executeFunction)" style="line-height: 13px;" />&nbsp;&nbsp;&nbsp;&nbsp;<input
