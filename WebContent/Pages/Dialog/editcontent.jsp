...
<%@ page language="java" import="com.gnamp.server.model.RectImage"%>
<%@ taglib uri="/struts-tags" prefix="s"%>

<%
RectImage r = (RectImage)request.getAttribute("rectImage");
%>
  ...
  %>
	...
	<div class="tcWindow">
		...
		<form id="form1" class="niceform">	
		    <input type="hidden" value="<%=r.getTaskId() %>" name="rectImage.taskId" />	
		    <input type="hidden" value="<%=r.getProgramId() %>" name="rectImage.programId" />
		    ...
		    <input type="hidden" value="<%=r.getSequenceNum() %>" name="rectImage.sequenceNum" />
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="0"
				...
				<tr>
					...
					<td><select size="1" id="rectImage.swapStyle" name="rectImage.swapStyle">	
