...
<%
LoopProgram p = (LoopProgram)request.getAttribute("loopprogram");
%>
  ...
  %>
	...
	<div class="tcWindow">
		...
		<form id="form1" class="niceform">	
		  <input type="hidden" value="<%=p.getTaskId() %>" name="loopprogram.taskId" />
		  <input type="hidden" value="<%=p.getProgramId() %>" name="loopprogram.programId" />	
				...
				<tr>
					...
					<td align="left">
						<input type="text" value="${loopprogram.programName }"  name="loopprogram.programName" />
				...
				<tr>
					...
					<td align="left">
						<input type="text" value="${loopprogram.description}"  name="loopprogram.description" />
					</td>
				</tr>
				<tr>
					<td class="bt" style="width: 40%">
