	...
	<div class="tcWindow">
		<div class="tcBt">
			<img src="${theme}/skins/default/images/tcBt1.gif" width="5" height="35"
				class="left" />
			<h2><s:text name="text_current" /><s:text name="text_plugintask" />:&nbsp;<%= task.getTaskName() %></h2>
			<img src="${theme}/skins/default/images/tcBt3.gif" class="right" />
		</div>
		<div class="tcNr">
			<form action="#" method="post" class="niceform">
 <input type="hidden" value="<%=task.getTaskId() %>" id="taskid" name="pluginprogram.taskId" />	
