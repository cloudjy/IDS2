...
<%@ include file="js/terminaljs.jsp"%>

<script type="text/javascript">
	$(function() {
		$("#zhongduan").addClass("hover");
	});
	$(function() {
		$('form').jqTransform({
...
<script type="text/javascript"> 
		...
		if (ok > 0) {
			...
			if (msg == "task") {
				...
				showIPUBDialogStand("terminal!ToTerminalTask?selectIDs="
						...
						{title:"<s:text name="terminaltask"/>",width:763,height:362});
			...
			if (msg == "edit") {
				...
				showIPUBDialogStand("terminal!ToModifyTerminal?selectIDs="
						+ selectIDs.substring(0, selectIDs.length - 1)
						+ "&terminal.groupId=" + groupid,{title:"<s:text name="editterminaltitle"/>",width:620,height:325});
			...
			if (msg == "monitor") {
				...
				showIPUBDialogStand("terminal!ToMonitor?selectIDs="
						+ selectIDs.substring(0, selectIDs.length - 1)
						+ "&terminal.groupId=" + groupid,{title:"<s:text name="text_control_title" />",width:996,height:396});
			}
			if (msg == "report") {
				var groupid = 0;
				try {
	...
	function add(pid) {
		...
		showIPUBDialogStand("terminal!ToAddTerminal?terminal.groupId="+ pid,{title:"<s:text name="createterminal"/>",width:515,height:290});
	...
	function watcherConfig() { 
		...
		var url = "${theme}/Pages/watcher!watcher?selectIDs=" + selectIDs;
		showIPUBDialogStand(url, {title:"<s:text name="title_offlinealarm_setting"/>",width:350,height:250});	
		return false;
	}
</script>
		...
		<div class="bt1">
			...
			<ul class="tab1">
			 ...
			 <ul class="topMenu" style="margin-top:0px;">
					   ...
					   <li><a href="#"><img id="v2" onclick="changeviewstate(2); return false;" title="<s:text name="carouselview"/>" src="${theme}/skins/default/images/b20.png" border="0" /></a></li>
					   <li><a href="#"><img id="v3" onclick="changeviewstate(3); return false;" title="<s:text name="demandview"/>" src="${theme}/skins/default/images/b21.png" border="0" /></a></li>
					   <li><a href="#"><img id="v4" onclick="changeviewstate(4); return false;" title="<s:text name="spotsview"/>" src="${theme}/skins/default/images/b22.png" border="0" /></a></li>
					  <%--  <li><a href="#"><img id="v5" onclick="changeviewstate(5); return false;" title="<s:text name="Pipe view"/>" src="${theme}/skins/default/images/b23.png" border="0" /></a></li> --%>
					   <li style="display:none;"><a href="#"><img id="v6" onclick="changeviewstate(6); return false;" title="<s:text name="programview"/>" src="${theme}/skins/default/images/b24.png" border="0" /></a></li>
					   <li style="display:none;"><a href="#"><img id="v7" onclick="changeviewstate(7); return false;" title="<s:text name="kernelview"/>" src="${theme}/skins/default/images/b25.png" border="0" /></a></li>
					   <li style="display:none;"><a href="#"><img id="v8" onclick="changeviewstate(8); return false;" title="<s:text name="configview"/>" src="${theme}/skins/default/images/b27.png" border="0" /></a></li>
				       <li style="display:none;"><a href="#"><img id="v5" onclick="changeviewstate(5); return false;" title="<s:text name="inspectionview"/>" src="${theme}/skins/default/images/b23.png" border="0" /></a></li>
					</ul>
			<form style="margin-top:-10px; width:450px;" class="topSearchMk2 topSearchMk3">
			...
			<div class="left1">
				...
				<div class="leftMenu">
				  ...
				  <%--    <span style="z-index:2012" onclick="groupsort();">A-Z</span> --%>
					...
					<!-- </div>	 -->
					<div onclick="querytodoterminal()" class="leftMenuBta">
				...
				<div class="leftButtonBox" style="margin-top: -75px;">
				     <s:if test="#session.current_privilege.newgroup">
					    <a href="javascript:void(0)" id="addNode" ><s:text name="new" /></a>
						</s:if>
						<s:if test="#session.current_privilege.editgroup">
						 	<a href="javascript:void(0)" id="editNode" ><s:text name="edit" /></a>
						</s:if>
						<s:if test="#session.current_privilege.delgroup">
						<a href="javascript:void(0)" id="removeNode"
							title="<s:text name="title_delete_group_button"/>">
							<s:text name="delete" />
						</a> 
						</s:if>
			...
			<div class="right1" id="terminaldiv" >
				...
				<div class="rightMenu" style="height: 20px;">
					...
					<ul class="left rightMenuShort">
						...
						<li style="display:none;" onclick="javascript: addmore(selectedId);"><s:text name="batch" /></li>
						</s:if>
						<s:if test="#session.current_privilege.editterminal">
						...
						<li style="display:none;"  onclick="javascript:importTer()"><s:text name="import" /></li>

						<li style="display:none;" onclick="javascript: exportexcel(); " ><s:text name="export" /></li> 
					</ul>
					
					<ul class="left rightMenuLong" style="margin-left: 20px;">
						<li onclick="javascript: del('task');"><s:text name="terminaltask" /></li>
					</ul>
					
					<ul class="right rightMenuLong">
						<% if (Context.watcherEnable()) { %>
					    <li onclick="javascript: watcherConfig();"><s:text name="text_offlinealarm"/></li>
					    <% } %>
					    <li onclick="javascript: del('see');" style="display:none;"><s:text name="viewscreenshot"/></li>
						<li onclick="javascript: del('report');" style="display:none;"><s:text name="terminalexport" /></li>
						<li onclick="javascript: del('exp');" style="display:none;"><s:text name="button_problem" /></li>
						<li onclick="javascript: del('upgrade');" style="display:none;"><s:text name="upgrade" /></li>
						<s:if test="#session.current_privilege.editterminal">
				...
				<div style="font-size:12px;padding-left:20px;"><s:text name="bottom_prompt_terminal_manager"/></div>
