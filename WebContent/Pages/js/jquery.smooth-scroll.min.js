 ...
 * 
 * Date: Sun Mar 11 18:17:42 2012 EDT Requires: jQuery v1.3+
 * 
 * Copyright 2012, Karl Swedberg Dual licensed under the MIT and GPL licenses
 * (just like jQuery): http://www.opensource.org/licenses/mit-license.php
...
(function(b) {
	...
	var n = function(c) {
		var e = [], a = false, d = c.dir && c.dir == "left"
				? "scrollLeft"
				: "scrollTop";
		this.each(function() {
	...
	b.fn.extend({
		...
		smoothScroll : function(c) {
			c = c || {};
			var e = b.extend({}, b.fn.smoothScroll.defaults, c), a = b.smoothScroll
					.filterPath(location.pathname);
			this.die("click.smoothscroll").live("click.smoothscroll",
					function(d) {
						var g = {}, i = b(this), f = location.hostname === this.hostname
								|| !this.hostname, h = e.scrollTarget
								|| (b.smoothScroll.filterPath(this.pathname) || a) === a, k = m(this.hash), j = true;
	...
	b.smoothScroll = function(c, e) {
		...
		if (typeof c === "number") {
			...
			g = e || b(a.scrollTarget)[d]()
					&& b(a.scrollTarget)[d]()[a.direction] || 0
		}
		a = b.extend({
					link : null
				}, a);
	...
	b.smoothScroll.filterPath = function(c) {
		return c.replace(/^\//, "").replace(/(index|default).[a-zA-Z]{3,4}$/,
				"").replace(/\/$/, "")
	};
