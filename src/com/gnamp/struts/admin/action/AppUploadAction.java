   ...
   extends AdminBaseAction
 {
   ...
   public String getWholeFilePath()
   {
     return 
       ...
       getTempDirectory() + getUserId() + File.separatorChar + "app" + File.separatorChar + getUpload0FileName();
   }
   ...
   public void upload()
   {
     ...
     try
     {
       ...
       if ((this.jufinal < 0) && (this.jupart < 0))
       {
         File wholeFile = new File(getWholeFilePath());
       ...
       if ((this.jufinal > 0) || ((this.jufinal < 0) && (this.jupart < 0)))
       {
         ...
         appHandle.upload(
           getWholeFilePath(), 
           PackageFile.getVersion(getWholeFilePath()), 
 ...
 * Qualified Name:     com.gnamp.struts.admin.action.AppUploadAction
